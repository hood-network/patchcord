...
THREAD_TYPES = (ChannelType.NEWS_THREAD, ChannelType.PUBLIC_THREAD, ChannelType.PRIVATE_THREAD)
...
EVENTS_TO_INTENTS = {
    ...
    "MESSAGE_REACTION_ADD": (Intents.DIRECT_MESSAGE_REACTIONS, Intents.GUILD_MESSAGE_REACTIONS),
    "MESSAGE_REACTION_REMOVE": (Intents.DIRECT_MESSAGE_REACTIONS, Intents.GUILD_MESSAGE_REACTIONS),
    "MESSAGE_REACTION_REMOVE_ALL": (Intents.DIRECT_MESSAGE_REACTIONS, Intents.GUILD_MESSAGE_REACTIONS),
    "MESSAGE_REACTION_REMOVE_EMOJI": (Intents.DIRECT_MESSAGE_REACTIONS, Intents.GUILD_MESSAGE_REACTIONS),
